...
# Output: list of unique pinyins (different tones can be regarded as equal or unequal)

import sys

f1 = open("yale-raw.txt", "r")			# format: char,pinyin with tone number
# fo = sys.stdout
fo = open("yale-unique-pinyins.txt", "w")
